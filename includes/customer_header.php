...
<body>
    ...
    <nav class="nav-bar">
        <div class="nav-inner">
            ...
            <a href="<?php echo $baseUrl; ?>/products/products.php?category=furniture" class="nav-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 18v3M20 18v3M4 10h16M4 14h16M4 10V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4M12 10v4"/></svg> Furniture
            </a>
            <a href="<?php echo $baseUrl; ?>/products/products.php?category=laptops" class="nav-item">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="2" y1="20" x2="22" y2="20"/><line x1="12" y1="17" x2="12" y2="20"/></svg> Laptops
            </a>
